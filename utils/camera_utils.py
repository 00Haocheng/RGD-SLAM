...
class Camera(nn.Module):
    ...
    def init_from_dataset(dataset, idx, projection_matrix):
        ...
        color_name=dataset.color_paths[idx].split('/')[-1]
        return Camera(
            idx,
            gt_color,
            gt_depth,
    ...
    def update_cam_delta(self, cam_rot_delta, cam_trans_delta):
        self.cam_rot_delta = cam_rot_delta.to(device=self.device)
        self.cam_trans_delta = cam_trans_delta.to(device=self.device)
